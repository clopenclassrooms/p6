 ...
 * 
 * @UniqueEntity(fields="name", message="Un article existe déjà avec ce titre.")
 * 
 */
class Trick
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Illustration::class, mappedBy="trick", orphanRemoval=true, cascade={"persist"})
     */
