...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/TrickFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\TrickFixtures(($container->privates['App\\Repository\\UserRepository'] ?? $container->load('getUserRepositoryService')), ($container->privates['App\\Repository\\TrickRepository'] ?? $container->load('getTrickRepositoryService')), ($container->privates['App\\Repository\\TrickGroupRepository'] ?? $container->load('getTrickGroupRepositoryService')), ($container->services['security.password_encoder'] ?? $container->load('getSecurity_PasswordEncoderService'))), 'groups' => []]]);
