...
class __TwigTemplate_42ac885714a97e7c41c9ba6eaa94835d3ea90ac23e90938c60ff9ea61486fa62 extends Template
{
    private $source;
    private $macros = [];
    ...
    <p>
        Si votre compte existe, un email vous a été envoyé.
        Cliquez sur le lien qu'il contient pour créer un nouveau mot de passe.
    </p>
    <p><a href=\"";
        // line 11
...
{% block body %}
    ...
    <p><a href=\"{{ path('homepage') }}\")>Retour à l'accueil</a>
    </div>
{% endblock %}
", "reset_password/check_email.html.twig", "/app/myapp/templates/reset_password/check_email.html.twig");
    }
}
